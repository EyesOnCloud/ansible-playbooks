...
extends_documentation_fragment:
  ...
  - redhat.rhel_system_roles.attributes.platform
attributes:
  check_mode:
    support: full
  diff_mode:
...
notes:
  ...
  - The M(redhat.rhel_system_roles.sefcontext) module does not modify existing files to the new SELinux context(s), so it is advisable
